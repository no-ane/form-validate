...
exports.default = {
  ...
  // phone 默认提供条件
  handleCustomRuleByPhone: function handleCustomRuleByPhone(rule) {
  ...
  // between 附加条件
  handleOtherRuleByBetween: function handleOtherRuleByBetween(rule) {
  ...
  // expire 附加条件
  handleOtherRuleByExpire: function handleOtherRuleByExpire(rule) {
  ...
  // ipAllow 附加条件
  handleOtherRuleByIpAllow: function handleOtherRuleByIpAllow(rule) {
